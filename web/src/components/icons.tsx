// Shared inline SVG icons. Stroke-based outlines read clearly at 14–16px
// and inherit color from the parent's `text-*` class. All icons take
// `className` so the caller sets the size; pass nothing to inherit the
// default 1em × 1em.

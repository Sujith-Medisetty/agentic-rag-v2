...
// All sessions for a project, newest-first. The server returns the full
// list — no pagination — so the SessionList page and the Workspace
// sidebar both get every row in one round trip.
